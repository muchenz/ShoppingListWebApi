        ...
        public  async Task SendRefreshMessageToUsersAsync(IEnumerable<int> usersIds, string command = null, int? id1 = null, int? listAggregationId=null, int? parentId=null)
        {
           using var scope = _serviceProvider.CreateScope();
            ...
            try
            {
                ...
                {
                    await _hubConnection.SendAsync("SendToAsync", usersIds, command, id1, listAggregationId, parentId);
                }
                else
                {
                    await _hubConnection.SendAsync("SendToAsync", usersIds, null, null, null, null);
                }
