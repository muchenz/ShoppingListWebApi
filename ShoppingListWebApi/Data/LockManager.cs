...
public class LockManagerLinkedListV2
{
    ...
    private readonly TimeSpan _cleanupInterval = TimeSpan.FromMinutes(5);
    private readonly SemaphoreSlim _stateLock = new SemaphoreSlim(1, 1);
    public LockManagerLinkedListV2()
    {
        _cleanupInterval = TimeSpan.FromMinutes(5);
    ...
    public class LockBuilder
    {
        private readonly LockManagerLinkedListV2 _lockManager;
        private readonly List<string> _keys = new();

        public LockBuilder(LockManagerLinkedListV2 lockManager)
        {
            _lockManager = lockManager;
        }
    ...
    private class Releaser : IAsyncDisposable
    {
        ...
        public Releaser(List<LinkedListNode<LockInfo>> nodeList, LockManagerLinkedListV2 lockManager)
        {
            _nodeList = nodeList;
            _lockManager = lockManager;
        }
